...
BEGIN
{
  ...
  $postmaster        = 'webmaster@michael-paetzold.de';
  @referers          = qw(michael-paetzold.de xn--devgroupgks-zfb.de localhost);
  @allow_mail_to     = qw(mail@michael-paetzold.de office@xn--devgroupgks-zfb.de);
  @recipients        = ();
  %recipient_alias   = ();
